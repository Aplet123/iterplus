...
class IterPlus {
     ...
     * @returns The generated iterator.
     */
    static successors(first /* o:-> */, func /* o:-> */) {
        /* o:async */ function* ret() {
    ...
    nubBy(cmp /* o:-> */) {
        ...
        /* o:async */ function* ret() {
            const seen = [];
            outer: /* r:for await */ for (const elem of that) {
        ...
        /* o:async */ function* ret() {
            while (true) {
                ...
                for (let i = 0; i < step - 1; i++) {
                    const skipped = /* o:await */ that.next();
                    if (skipped.done) {
                        return;
                    }
                }
